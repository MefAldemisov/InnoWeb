...
preserveAspectRatio="xMidYMid" width="34" height="33.97" viewBox="0 0 34 33.97">
`

const social_icons = {
    facebook: `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                preserveAspectRatio="xMidYMid" width="34" height="33.97" viewBox="0 0 34 33.97">
                <path
    ...
    twitter: `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                preserveAspectRatio="xMidYMid" width="34" height="34" viewBox="0 0 34 34">
                <path
    ...
    behance: `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                preserveAspectRatio="xMidYMid" width="35" height="33.97" viewBox="0 0 35 33.97">
                <path
    ...
    dribble: `<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                preserveAspectRatio="xMidYMid" width="34" height="33.75" viewBox="0 0 34 33.75">
                <path
...
for (f of new_films) {
    ...
    if(film.getSocial.call(f)){
        for (soc_net of ["facebook", "twitter", "behance", "dribble"]){
            if (film.getSocialList.call(f).includes(soc_net)){
                addition = `<a href=${film.getSocial.call(f)[soc_net]} target="_blank" title="twitter social network">`                
    ...
    let film_box = document.createElement("article")
