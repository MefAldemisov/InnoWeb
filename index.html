...
<body>
            ...
            <div id="first-line" class="header__first-line">
                <div class='header__logo-container'>
                    <a href="http://university.innopolis.ru" target="_blank">
                        <img class="header__inno-logo" src="images/logo_inno.png" alt="logo of Innopolis"
    ...
    <section class="present">
        ...
        <div class="present__text-container">
            ...
            <article class="present__text">
                ...
                <button class="present__button">Получить подарок</button>
            </article>
        </div>
        <div class="background-triangle"></div>
    </section>
    ...
    <section class="form__container">
        <form autocomplete="off" method="POST" action="serv.php">
            <div class="form__part">
                <label for="input_name">Укажите ваше имя</label>
                <input id="input_name" type="text" value="Defalt_name" name="name" placeholder="Имя"
                    required="required">
            </div>
            <div class="form__part">
                <label for="input_mail">Укажите email </label>
                <input id="input_mail" type="email" placeholder="something@gmail.com" required="required"
                    autocomplete="on">
            </div>
            <div class="form__part">
                <label for="option_select">Выберите место </label>
                <select id="option_select" name="option" required="required">
            ...
            <fieldset class="form__part">
                ...
                <input id="choice1" type="radio" value="1" name="variant">
                <label for="choice1">
                    Выбор 1
                </label>
                <input id="choice2" type="radio" value="2" name="variant">
                <label for="choice2">
                    Выбор 2
                </label>
            </fieldset>
            ...
            <button id="send_present" class="form__part" type="submit">Заказать</button>
        </form>
    </section>
    <section class="map">
    ...
    <footer id="section_contacts" class="contacts__container">
            ...
            <div class="contacts__icons">
                ...
                <a href="https://www.tumblr.com" target="_blank" title="Tumblr social network">
                    <svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid"
                        xmlns:xlink="http://www.w3.org/1999/xlink" width="49px" height="49px" viewBox="0 0 49 48.06">
                        <defs>
                            <filter filterUnits="userSpaceOnUse" id="drop-shadow" x="0px" y="0px" width="49px"
                                height="49px">
                        ...
                        <path
                            d="M23.999,46.499 C11.573,46.499 1.499,36.426 1.499,23.999 C1.499,11.573 11.573,1.499 23.999,1.499 C36.425,1.499 46.499,11.573 46.499,23.999 C46.499,36.426 36.425,46.499 23.999,46.499 ZM31.494,31.637 C27.617,33.423 25.488,32.812 25.488,29.760 C25.488,28.170 25.492,23.493 25.492,23.493 L30.500,23.493 L30.500,19.481 L25.487,19.484 L25.487,13.459 C25.487,13.459 23.197,13.458 22.088,13.458 C21.902,16.235 20.968,17.807 17.514,19.505 C17.514,20.634 17.511,23.470 17.511,23.470 L20.500,23.470 C20.500,23.470 20.500,31.154 20.500,32.489 C20.500,35.129 22.908,36.154 24.619,36.404 C26.737,36.714 29.374,36.329 31.494,35.632 C31.494,34.386 31.494,33.257 31.494,31.637 Z"
                            class="svg-icon" />
                    </svg>
                </a>
            </div>
        ...
        <div id="order-form__container" class="order-form__container">
            <form id=order-form class=order-form>
                <button id="order-form__close-btn">X</button>
                <div class="form__part">
                ...
                <div class=form__part>
                    ...
                    <input title="Формат: x-xxx-xxx-xx-xx" id="order-form__phone-number" type="tel"
                        pattern="[0-9]-[0-9]{3}-[0-9]{3}-[0-9]{2}-[0-9]{2}" required value=""></input>
                </div>
                <div class=form__part>
